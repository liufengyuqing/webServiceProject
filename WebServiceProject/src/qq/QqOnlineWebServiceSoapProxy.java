...
public class QqOnlineWebServiceSoapProxy implements qq.QqOnlineWebServiceSoap {
  private String _endpoint = null;
  private qq.QqOnlineWebServiceSoap qqOnlineWebServiceSoap = null;
  ...
  private void _initQqOnlineWebServiceSoapProxy() {
    try {
      qqOnlineWebServiceSoap = (new qq.QqOnlineWebServiceLocator()).getqqOnlineWebServiceSoap();
  ...
  public qq.QqOnlineWebServiceSoap getQqOnlineWebServiceSoap() {
    if (qqOnlineWebServiceSoap == null)
      _initQqOnlineWebServiceSoapProxy();
